...
% REVISÃO: "Buda" — em todo o livro alterna-se entre "Buda" e "Buddha"; uniformizar para "Buddha" (forma dominante e usada no resto deste capítulo).
% REVISÃO: "origem de todo sofrimento" — em português europeu usa-se o artigo: "de todo o sofrimento" (também na linha que começa "É importante reflectir...").
...
% REVISÃO: "a razão porque surge" — neste sentido escreve-se separado: "a razão por que surge" (ou "a razão pela qual surge").
...
dizer que esta Buddha-rūpa (estátua de Buddha) saiba alguma coisa; mais do que
...
% REVISÃO: "que esses tempos são passado" — concordância/expressão incorrecta; corrigir para "que esses tempos já passaram" ou "que esses tempos são coisa do passado".
