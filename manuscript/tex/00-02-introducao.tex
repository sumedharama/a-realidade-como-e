...
% REVISÃO: frase de difícil leitura (provável resíduo de tradução). O período "Embora não seja possível traduzir ... numa obra impressa, acrescentada de breves exortações ... pode sugerir a atmosfera ..." fica sem sujeito explícito para "pode sugerir" e com a aposição "acrescentada de" deslocada. Reescrever, p.ex.: "Embora não seja possível traduzir ... numa obra impressa, esta — acrescida de breves exortações, directrizes e reflexões ... — pode sugerir a atmosfera ...".
...
% REVISÃO: "egotista" — usar "egoísta" por coerência (cf. "actividade egoísta", "motivações egoístas" no resto do livro).
...
% REVISÃO: nos dois quotes traduz-se "jarā-maraṇaṁ" por "a velhice, a doença e a morte". "jarā-maraṇa" é apenas "velhice e morte"; "doença" é um acrescento que não está no Pali. Verificar se é intencional ou deve ser removido.
...
(\emph{phassa}) que pode suscitar (\emph{paccayā}) vários graus de sensação
