...
% REVISÃO: "concepções egotistas" — o livro alterna entre "egotista", "egoísta" e "egocêntrica" (cf. "visão egocêntrica" mais abaixo, neste mesmo capítulo). Uniformizar o termo.
...
% REVISÃO: "Pode se ser algo útil" — colocação incorrecta; em PT-PT: "Pode-se ser algo útil" (ou "Pode ser-se algo útil").
...
% REVISÃO: "em Tailandês" — nome de língua escreve-se com minúscula: "em tailandês".
...
% REVISÃO: na nota de rodapé "cerimônia" está com circunflexo (grafia do PT-BR); em PT-PT é "cerimónia" (como no corpo do texto).
