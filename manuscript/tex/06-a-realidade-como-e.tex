...
do Dhamma devia ser muito, muito simples em vez de complicada. Muitos
...
% REVISÃO: "não devia de ser assim" — aqui exprime-se obrigação, pelo que se escreve sem "de": "não devia ser assim" (cf. "Ele devia ser" na mesma frase).
...
% REVISÃO: "enfâse" é gralha — a acentuação correcta é "ênfase".
...
% REVISÃO: "decidir nos pautarmos" — colocação pronominal do PT-BR; em PT-PT: "decidir pautar-nos por padrões morais".
...
% REVISÃO: "o peso de sua postura" — falta o artigo em PT-PT: "o peso da sua postura".
