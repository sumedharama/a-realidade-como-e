...
% REVISÃO (ortografia): capítulo em grafia do Acordo de 1990 ("objetos", "reação", "refletir", "exatamente", "atratividade"); uniformizar com a grafia pré-Acordo dos capítulos 00–19.
% REVISÃO (terminologia): usa-se o anglicismo "insight" (linhas 11, 30, 146, 149), ao passo que no resto do livro se traduz por "compreensão lúcida"/"discernimento". Uniformizar. Também "Buda" (linhas 20, 190) → "Buddha".
% REVISÃO (aspas): o capítulo mistura `...' (ex.: linhas 12–26, 74–77) e «...»; uniformizar com o estilo adoptado para o livro.
...
e o devir (taṇhā-upādāna-bhava). Tornamo-nos aquilo que desejamos. Agora
...
% REVISÃO: "desejas-o" — com verbo terminado em -s, a forma enclítica é "deseja-lo" (cai o -s e usa-se -lo).
...
contemplar o \emph{vedanā}. Podemos observar e contemplar o que é a atração e o
...
% REVISÃO: "atrairia-vos" — colocação incorrecta; com o futuro do pretérito usa-se mesóclise: "atrair-vos-ia".
...
o \emph{saṁsāra} é o ciclo, a interminável correria à procura da próxima coisa
...
agradam-nos e fascinam-nos. E se uma experiência é desagradável, tememos-a. % REVISÃO: "tememos-a" — verbo terminado em -s leva a forma "-la" (cai o -s): "tememo-la".
...
nossa atenção para o \emph{vedanā}. Mas também não nos apegamos à neutralidade:
...
O \emph{vedanā} condiciona o \emph{taṇhā}. Então, o que é o \emph{taṇhā}? Esta
...
de \emph{saṁsāra} a girar e girar, apenas a desejar; a tornar-nos alguém que
quer algo, a tornar-nos alguém que não quer algo. E isso, claro, condiciona o
renascimento, \emph{jāti}. Condiciona a velhice, a doença, a morte, a tristeza,
o lamento, a dor, o sofrimento e o desespero -- a depressão, a miséria;
\emph{«jarā-maraṇaṁ-soka-parideva-dukkha-domanassa-upāyāsa»}.
...
desejo-apego-devir (\emph{taṇhā-upādāna-bhava}). A partir daí, a sequência
de \emph{paṭiccasamuppāda} leva ao nascimento, envelhecimento, morte, tristeza,
lamentação, dor, pesar e desespero
(\emph{jāti-jarā-maraṇaṁ-soka-parideva-dukkha-domanassa-upāyāsa}). Toda a
sequência de sofrimento decorre de \emph{taṇhā-upādāna-bhava}.
