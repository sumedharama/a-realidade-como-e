...
% REVISÃO: "Por é que não podemos alcançar" — falta "que": "Porque é que não podemos alcançar" (cf. "porque é que isso acontece" na frase anterior).
...
% REVISÃO: "canadense" é a forma do PT-BR; em PT-PT é "canadiano".
...
% REVISÃO: mudança de pessoa dentro da mesma citação — "Tive...", "eu compreendia" (1.ª pessoa) seguido de "pensaste que eras" (2.ª pessoa). Uniformizar ("E até pensei que era um arahant.") ou marcar claramente a auto-interpelação. Note-se ainda que "arahant" aqui não está em itálico, ao contrário de "\emph{arahant}" acima.
...
% REVISÃO: "caia" — falta o acento (imperfeito de "cair"): "caía".
