...
% REVISÃO: incoerência de aspas — este capítulo mistura ``...'', «...» e `...'. Além disso, os capítulos 00–16 usam ``...'' e os capítulos 17–26 usam «...»; uniformizar o estilo de aspas em todo o livro.
% REVISÃO: incoerência de tratamento — este capítulo alterna entre "vocês" (ex.: "quantos de vocês") e a 2.ª pessoa do singular "tu" (penses, podes, te vejas). Uniformizar a forma de tratamento.
% REVISÃO: "aos quais ninguém raramente presta atenção" — dupla negação contraditória; corrigir para "a que quase ninguém presta atenção" ou "a que raramente se presta atenção".
...
% REVISÃO: "Luan Por Chah" — falta o "g": "Luang Por Chah" (como mais à frente neste capítulo).
...
% REVISÃO: "que os fiéis apressariam-se para ver" — a conjunção "que" exige próclise: "que os fiéis se apressariam a ver" (e "apressar-se a", não "para").
...
% REVISÃO: "o tempo tedo" é gralha — "o tempo todo".
