...
% REVISÃO: "adversos a isso" — provável troca de palavra; o sentido é "avessos a isso" (que têm aversão).
...
% REVISÃO: "não devíamos nos preocupar" — colocação do PT-BR; em PT-PT "não devíamos preocupar-nos" (ou "não nos devíamos preocupar").
...
% REVISÃO: "nada em que pensamento for" — frase truncada/sem sentido; reformular (p. ex. "nada existe nisso, seja qual for o pensamento").
...
% REVISÃO: "querer nos livrar deles" — colocação do PT-BR; em PT-PT "querer livrar-nos deles".
