...
Depois, há \emph{o karuṇā}. \emph{Karuṇā} é compaixão. Quando vemos o sofrimento dos
...
experiência da alegria para tentar tê"-la o tempo todo. Mas \emph{a muditā} é
...
através dos \emph{brahma"-viharas} -- \emph{mettā, karuṇā, muditā} e
...
formações mentais, então existe a maneira como as coisas são -- os \emph{lokiya
  dhammas.} Mas não estamos a pedir que \emph{o muditā} seja uma experiência
