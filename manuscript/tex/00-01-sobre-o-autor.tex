...
O Venerável Ajahn Sumedho é um bhikkhu da escola Theravāda de Budismo, uma
...
% REVISÃO: "acabou permanecendo" é construção do PT-BR (acabar + gerúndio); em PT-PT usar "acabou por permanecer".
...
Vihāra, forneceu um ponto de partida razoável, mas as vantagens de um ambiente
...
% REVISÃO: "vilarejo" é forma do PT-BR; em PT-PT usar "aldeia" (de Great Gaddesden).
...
% REVISÃO: "atualizada" deveria ser "actualizada" — o livro usa a grafia pré-Acordo Ortográfico (cf. "actual", "objectivo", "directa"), pelo que esta forma é uma inconsistência.
