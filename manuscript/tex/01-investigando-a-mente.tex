...
% REVISÃO: falta de paralelismo na colocação pronominal — "de o rejeitarmos, reprimirmos ou ignorá-lo" mistura próclise e ênclise. Uniformizar: "de o rejeitarmos, reprimirmos ou ignorarmos" (ou "rejeitá-lo, reprimi-lo ou ignorá-lo").
...
% REVISÃO: "Ridículo?" — o ponto de interrogação não faz sentido aqui; deve ser ponto de exclamação ("Ridículo!").
