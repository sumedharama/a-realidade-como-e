...
Uma vez, num retiro, ouvi uma pessoa que estava a ter problemas em engolir.
% REVISÃO: onomatopeia inconsistente — "`glup glup'" e depois "`gulp'"; uniformizar a grafia.
...
% REVISÃO: "controlar nossas vidas" — em PT-PT usa-se o artigo: "controlar as nossas vidas".
...
% REVISÃO: "toda experiência humana" — em PT-PT usa-se o artigo: "toda a experiência humana".
...
\photoPage{image-008-forest-path.jpg}{Hammer Wood, Vihāra de Cittaviveka, Chithurst}{Foto por Derek Gardiner}
