...
% REVISÃO (ortografia): capítulo em grafia do Acordo de 1990 ("refletir", "direção", "ação", "atividade", "direto", "conceptual"); uniformizar com a grafia pré-Acordo dos capítulos 00–19.
% REVISÃO (tratamento e termos): mistura "tu", "você" e "vós"; e "Buda" em vez de "Buddha". Uniformizar.
% REVISÃO (transcrição): sendo transcrição de uma palestra, contém marcas de oralidade a limpar — hesitações ("uh", linha 414), repetições ("nós, nós pensamos"; "O que nós, e, sentimos", linha 330) e frases muito longas/corridas.
\emph{(Palestra de Dhamma dada a 6 de março de 2021)}
...
sua natureza é: \emph{anicca} -- impermanência, \emph{dukkha} -- insatisfatória, \emph{anatta} --
...
% REVISÃO: "Se os observares com um, eles surgem e cessam" — "com um" está truncado; falta o complemento (p. ex. "se os observares com atenção/consciência").
...
\emph{sāmaṇera}, há 55 anos, antes de conhecer Luang Por Chah, passei o primeiro ano
\emph{sāmaṇera} num mosteiro em Nong Khai, que fica em, no nordeste da Tailândia;
...
muito boas para mim, as monjas, as \emph{sāmaṇeras} que me forneciam comida todos os
dias, tive um bom apoio da comunidade em Nong Khai. Portanto, não tinha nada de
...
E foi o que fiz. E a raiva é um \emph{saṅkhāra}. Sabes, não é permanente. Não é o eu.
É \emph{anatta}. Então, quando resistia, havia um hábito de uma vida inteira naquela
...
Tive de ir ao posto de imigração em Nong Khai para prolongar o visto para ficar na
...
Isso é \emph{bhava taṇhā}. É o desejo de obter algo de que me lembro que não tenho
neste momento. Então comecei a despertar para o dhamma, para a forma como as
coisas são. \emph{Bhava taṇhā} é assim, querer obter algo de que te lembras ou que
concebes para que possas alcançar a iluminação ou tornar-te um arahant, ou para
te livrares de maus pensamentos, kilesas. Querer livrar-te disso é \emph{vibhava
taṇhā}, o desejo de te livrares do que não gostas, do que não queres.

É resistência, repressão. Assim, neste Ensinamento das Quatro Nobres Verdades,
estes três tipos de desejo -- \emph{kāma taṇhā, bhava taṇhā, vibhava taṇhā} --
...
vossa vida aqui em Amaravati tem a ver com \emph{vibhava taṇhā}, o desejo de se livrar
...
são \emph{saṅkhārās}. Todos os desejos, todo o \emph{taṇhā}, são impermanentes e não são o eu.
Assim, estas três características -- \emph{anicca, dukkha, anatta} -- dão-nos esta
...
vida deveria ser, como Amaravati deveria ser como um ideal\ldots{} como a vida
...
É \emph{anicca, dukkha, anatta}. Tudo muda. Surge e desaparece. Não é possível manter
...
expiração, no movimento e na mudança dos \emph{saṅkhāras}, do \emph{saṁsāra}, das condições
...
para o coração. Luang Por Chah falou-me sobre o que lhe perguntei uma vez há
