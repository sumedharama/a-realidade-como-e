...
ensinamento do Buddha. Toda a convenção do \emph{Vinaya} (disciplina) e dos
ensinamentos do \emph{Dhamma} existe para nos ajudar nesse sentido. Algumas
...
para o \emph{Dhamma-Vinaya}, o que fará alguém pensar que consegue fazê-lo
...
cessa -- e uma compreensão do \emph{Nibbāna}. Não há forma de realizarmos o
\emph{Nibbāna} pelo esforço e tentativa de se atingir e alcançar, e sermos
...
nobreza, generosidade, bondade e reflexão no \emph{Dhamma}. É maravilhoso poder
...
\photoPage{image6.jpeg}{Circumambulação no Vihara de Ratanagiri.}{Foto por Ron Livingston.}
