...
% REVISÃO (ortografia): este capítulo está escrito segundo o Acordo Ortográfico de 1990 ("perceção", "afetar", "exatamente", "direto", "proteção", "recetiva", "correta"), ao passo que os capítulos 00–19 usam a grafia pré-Acordo ("percepção", "afectar", "directo", etc.). Uniformizar a grafia em todo o livro.
% REVISÃO (terminologia): o título do capítulo diz "Génese Dependente", mas o corpo usa "Originação Dependente" (linhas 3, 12, 106). Uniformizar o termo de "paṭiccasamuppāda".
...
% REVISÃO: "Buda" (aqui e mais à frente) — uniformizar para "Buddha", como recomendado para todo o livro.
...
«Nibbāna, a felicidade suprema» -- mas «felicidade suprema» também não é bem
isso, pois não? «Felicidade suprema» soa a ficar «pedrado», a flutuar no ar, a
alcançar o Nibbāna e a flutuar até ao teto.
...
A palavra Nibbāna é geralmente definida como «desapego aos cinco
...
não-eu. Então, Nibbāna é a compreensão do desapego, em que a visão do eu cessa.
