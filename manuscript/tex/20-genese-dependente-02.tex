...
salienta que a sua abordagem tem incidido sobre o \emph{paticcasamuppada} como
...
partir de \emph{avijja} são momentâneos, não se trata de um tipo de
\emph{avijja} permanente. Seria uma visão errada supor que tudo começou com
\emph{avijja} e que, em algum momento no futuro, tudo cessaria.

\emph{Avijja} significa, neste sentido, «não compreender as Quatro Nobres
Verdades». Quando há compreensão do Sofrimento, da Origem, da Cessação e do
Caminho, então as coisas já não são afetadas por \emph{avijja}. Quando vemos com
\emph{vijja,} então as perceções são realidade convencional, já não «eu» e
«meu». Por exemplo, quando há \emph{vijja}, então posso dizer «Eu sou Ajahn
Sumedho» -- isso é uma realidade convencional, ainda uma perceção, mas já não é
vista a partir de \emph{avijja,} é meramente uma convenção que usamos. Não há
...
outra cessasse. Quando há \emph{vijja}, o sofrimento cessa. Em qualquer momento,
...
E, no entanto, \emph{vinnana} é sempre descrita como um momento, um momento
fugaz, um instante. Assim, em vez de assumirmos que \emph{avijja} é um processo
contínuo desde o nascimento até à morte, podemos ver que, a qualquer momento,
pode haver \emph{vijja} e tudo simplesmente cessa. A cessação de toda essa massa
...
\emph{vijja} e se torna recetiva, o Dhamma revela"-se; há uma espécie de
...
Caminho Óctuplo é desenvolvimento, \emph{bhavana}: desenvolver esse caminho para
...
ao corpo e à mente -- \emph{rupa, vedana, sanna, sankhara, vinnana}.
Contemplamos os cinco \emph{khandhas} não mais com \emph{avijja}, mas com
\emph{vijja.} Percebemos que todos eles são impermanentes, insatisfatórios e
...
\emph{vedana, sanna, sankhara} e \emph{vinnana} -- tudo isso cessa. O eu
